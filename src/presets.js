...
export const PRESETS = {
  ...
  // 手肘折彎方向改用解剖學基準之後重配（扭轉的意義變了）。
  // 手肘往兩側張到 x=1.90（肩在 0.97），手掌落在頭頂、距頭心 0.80 略為融接。
  '01 舉手抱頭': {
    armPitchL: 170, armOutL: -30, armTwistL: 80, elbowL: 105,
    armPitchR: 170, armOutR: -30, armTwistR: 80, elbowR: 105
  },
  '02 雙手歡呼': {
